        ...
        public static void main(String[] args) {
            ...
            while (true) {
                ...
                if (command == 1) {
                    ...
                    double sumExp = expenses.get(day-1)+expense;
                    expenses.remove(day-1);
                    expenses.add(day-1,sumExp);
                ...
                /* Объявляем переменную maxExpense для хранения самой большой суммы расходов.
                   Сначала её значение неизвестно, поэтому равно нулю */
                    double maxExpense = 0;
                    for (int i = 0; i < expenses.size(); i++) { // Проходим циклом по всему массиву трат
                        if (maxExpense<expenses.get(i)) { // Сравниваем, больше ли текущий элемент массива значения maxExpense
